...
##!!!!!!!!!!!!!!!!!!!!
# IMPLEMENT COMMON UPTAKE, EXCRETION TO FILTRATE AND TO ENVIRONMENT AND LEAVE ONLY
# REABSORPTION TO BE FITTED INDIVIDUALLY
...
ku_values <- log10(c(3e-1))
C_prot_init_values <- log10(c( 3e-6))
ka_values <- log10(c(1.5e7))
